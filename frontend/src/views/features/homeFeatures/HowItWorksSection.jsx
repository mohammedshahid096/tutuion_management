      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-5xl gap-8 py-12 md:grid-cols-3">
          <Card className="flex flex-col items-center text-center">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Choose your subject, date, and time for your personalized
                tutoring session.
              </p>
            </CardContent>
          </Card>
          <Card className="flex flex-col items-center text-center">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Connect via Google Meet for a face-to-face interactive learning
                experience.
              </p>
            </CardContent>
          </Card>
          <Card className="flex flex-col items-center text-center">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Receive personalized instruction, practice, and feedback to
                boost your skills.
              </p>
            </CardContent>
          </Card>
